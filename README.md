...
LayerTechnologyBackendDjango 5, Django REST FrameworkBackground tasksCelery + RedisDatabasePostgreSQLFile storageMinIO (dev) / AWS S3 (production)Forensic toolingyara-python, python-magic, hashlibReportsWeasyPrint (PDF generation)ContainerisationDocker, Docker ComposeTask monitoringFlower
...
ServiceURLApplicationhttp://localhost:8000Django Adminhttp://localhost:8000/adminMinIO Consolehttp://localhost:9001Flower (task monitor)http://localhost:5555
...
Roadmap
 ...
 Phase 1 — Core Django application (local Docker environment)
